...
object BleConstants {
    ...
    val SERVICE_UUID: UUID = UUID.fromString("0000MR01-0000-1000-8000-00805F9B34FB")

    /** Characteristic for receiving incoming mesh packets via GATT WRITE */
    val CHAR_PACKET_WRITE_UUID: UUID = UUID.fromString("0000MR02-0000-1000-8000-00805F9B34FB")

    /** Characteristic for node ID identification */
    val CHAR_NODE_INFO_UUID: UUID = UUID.fromString("0000MR03-0000-1000-8000-00805F9B34FB")
